            ...
            {page === 1 ? (
              ...
              <motion.div key="p2" initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 24 }} transition={{ duration: 0.3 }}>
                ...
                <div className="grid gap-3 sm:grid-cols-2" role="radiogroup">
                  {(
                    [
                      { v: "twoyear", name: "2-Year Certificate", itr: "Latest year ITR required" },
                      { v: "threeyear", name: "3-Year Certificate", itr: "Latest + previous year ITR required" },
                    ] as const
                  ).map((plan) => (
                    <button
                      key={plan.v}
                    ...
                    >
                      ...
                      <div className="mt-2 space-y-1 text-xs text-muted-foreground">
                        <div>
                          <span className="font-semibold text-foreground/70">Net Worth Certificate fee:</span>{" "}
                          <span className="font-bold text-brand-deep">₹8,000</span>{" "}
                          <span className="italic">issued by our affiliated CA</span>
                        </div>
                        <div>{plan.itr}</div>
                      </div>
                    </button>
